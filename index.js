...
const fullVociDE = ["die Post (Ort)", "die Post (Briefe)", "schicken, senden", "der Brief", "lieb", "lieb", "Sehr geehrte Damen und Herren", "die Briefmarke", "das Paket", "aufgeben", "die Postkarte", "die Postleihzahl", "der Briefkasten", "das Porto", "der Umschlag", "der Absender", "die Absenderin", "der Empfänger", "zustellen", "die Zustellung", "die Information", "informieren", "die Zeitung", "die Tageszeitung", "die Zeitschrift", "die Zeitschrift, die Illustrierte", "die Wochenzeitschrift", "die Monatszeitschrift", "der Artikel", "die Ausgabe", "das Abonnement", "abonnieren", "das Radio", "das Fernsehen", "das Fernsehen", "fernsehen", "senden", "die Sendung", "das Programm", "der Sender", "der Sender", "die Nachrichten (f)", "die Nachrichten (f)", "der Werbespot", "wahr", "die Wahrheit", "die Presse", "die Reportage", "das Interview (f)", "die Titelseite", "auf der Titelseite", "die Schlagzeile", "das Bild (f)", "live", "die Wirklichkeit", "die Tatsache", "objektiv", "unglaublich", "das Telefon", "telefonieren", "anrufen", "anrufen", "die Telefonnummer", "das Handy", "das Handy", "Handynummer", "die SMS", "die SMS", "simsen", "wählen", "sich verwählen", "der Anruf", "der Anruf", "die Nachricht", "der Anrufbeantworter", "ans Telefon gehen", "Nicht auflegen", "Hallo", "Wer ist am Apparat?", "Auf Wiederhören", "besetzt", "verbinden mit, durchstellen zu", "zurückrufen", "die Vorwahl", "das WLAN", "die E-Mail", "die E-Mail", "die E-Mail-Adresse", "der Newsletter", "der Anhang", "das Internet", "im Internet surfen", "googeln", "online", "das Onlinebanking", "der Onlineshop", "offline", "der Link", "herunterladen", "der Browser", "der Server", "die Leitung", "klingeln", "Klingelton", "abnehmen", "auflegen", "das Ferngespräch", "das Ortsgespräch", "die Mailbox", "die Durchwahl", "die MMS", "das Smartphone", "die App", "das E-Book", "die SIM-Karte", "die Freisprechanlage", "das Festnetz", "das Mobilfunknetz", "die Flatrate", "das soziale Netzwerk", "skypen", "twittern", "@-Zeichen", "der E-Mail-Account", "das Junkmail", "der Spamfilter", "der (Internet-)Provider", "die Suchmaschine", "die Homepage", "die Website", "der Blog", "bloggen", "der Blogger", "die Bloggerin", "der Chat", "chatten", "das Log-in", "sich einloggen", "sich ausloggen", "der Benutzername", "der Cookie", "der Hashtag", "der Computer", "der PC", "die Software", "die Hardware", "das Programm", "programmieren", "die Tastatur", "der Bildschirm", "der Drucker", "ausdrucken", "die Taste", "löschen", "einfügen", "die Escape-Taste", "die Enter-Taste", "die Maus", "die Maustaste", "der Cursor", "klicken", "der Mausklick", "der Doppelklick", "das Menü", "die Daten", "die Datei", "der Ordner", "eingeben", "installieren", "deinstallieren", "herunterfahren", "hochfahren", "speichern", "kopieren", "aufnehmen", "der Laptop", "das Tablet", "der Touchscreen", "das Touchpad", "der Desktop", "das Icon", "das Mauspad", "das Betriebssystem", "das Computerspiel", "die Datenbank", "digital", "virtuell", "interaktiv", "Multimedia-, multimedial", "die Sicherheitskopie", "neu starten", "scrollen", "das Passwort", "die Fehlermeldung", "der Screenshot", "der Virenscanner", "der Scanner", "scannen", "der Computervirus", "der USB-Stick", "die Festplatte", "der Hacker", "hacken"]; 
const FullVociEN = ["la poste", "le courrier", "envoyer", "la lettre", "cher", "chère", "Mesdames, Messieurs!", "le timbre", "le paquet", "poster", "la carte postale", "le code postal, pl. codes postaux", "la boîte (aux lettres)", "le port", "l'enveloppe f", "l'expéditeur m", "l'expéditrice f", "le destinataire", "remettre", "la remise", "le renseignement", "informer", "le journal, pl. journaux", "le quotidien", "le magazine", "la revue", "le hebdomadaire", "le mensuel", "l'article m", "l'édition f", "l'abonnement m", "s'aboonner à", "la radio", "la télévision", "la téle", "regarder la télévision", "transmettre", "l'émission", "le programme", "la chaîne", "la station", "les actualités", "les informations", "le spot publicitaire", "vrai, vraie", "la vérité", "la presse", "le reportage", "l'interview", "la une", "à la une", "le gros titre", "l'image", "en direct", "la réalité", "le fait", "objectif, objective", "incroyable", "le téléphone", "téléphoner", "téléphoner à", "appeler qn", "le numéro de téléphone", "le portable", "le téléphone mobile", "le numéro de portable", "le SMS", "le texto", "écrire des textos", "composer", "se tromper de numéro", "l'appel m", "le coup de fil", "le message", "le répondeur", "répondre", "Ne quittez pas", "allô", "Qui est à l'appareil?", "Au revoir!", "occupé, occupée", "passer", "rappeler", "l'indicatif m", "le wifi", "l'e-mail m", "le courriel", "l'adresse e-mail f", "la lettre d'information", "la pièce jointe", "l'Internet m", "surfer sur Internet", "chercher sur Google", "en ligne", "la banque en ligne", "la boutique en ligne", "hors connexion", "le lien", "télécharger", "le navigateur", "le serveur", "la ligne", "sonner", "la sonnerie", "décrocher", "raccrocher", "la communication interurbaine", "la communication locale", "la messagerie vocale", "le numéro direct", "le MMS", "le smartphone", "l'appli", "le livre numérique", "la carte SIM", "le kit mains libres", "le réseau fixe", "le réseau de téléphonie mobile", "le forfait illimité", "le réseau social", "skyper", "tweeter", "l'arobase", "le compte de courrier (électronique)", "le courrier indésirable", "le filtre anti-spam", "le fournisseur", "le moteur de recherche", "la page d'accueil", "le site web", "le blog", "bloguer", "le blogueur", "la blogeuse", "la conversation en ligne", "bavarder en ligne", "la connexion", "se connecter", "se déconnecter", "le nom d'utilisateur", "le cookie (témoin de connexion)", "le mot-dièse", "l'ordinateur", "le PC", "le logiciel", "le matériel", "le programme", "programmer", "le clavier", "l'écran m", "l'imprimante f", "imprimer", "la touche", "supprimer", "insérer", "la touche échappe", "la touche entrée", "la souris", "le bouton de la souris", "le curseur", "cliquer", "le clic de la souris", "le double-clic", "le menu", "les données", "le fichier", "le dossier", "entrer", "installer", "désinstaller", "éteindre", "démarrer", "mémoriser", "copier", "enregistrer", "l'ordinateur portable m", "la tablette", "l'écran tactile m", "le pavé tactile", "le bureau", "l'icône f", "le tapis de souris", "le système d'exploitation", "le ludiciel", "la base de données", "numérique", "virtuel/le", "interactif/ve", "multimédia", "la sauvegarde", "redémarrer", "faire défiler", "le mot de passe", "le message d'erreur", "la capture d'écran", "l'antivirus m", "le scanner", "scanner", "le virus informatique", "la clé USB", "le disque dur", "le pirate (informatique)", "pirater"]
